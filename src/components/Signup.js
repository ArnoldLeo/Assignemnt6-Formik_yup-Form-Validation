...
function Signup(props) {
    ...
    return (
        <div className='container border mt-5' style={{width:'50%'}}>
            <Formik
                ...
                {(props) => (
                    <Form>
                        <div className='container'>
                            ...
                            <div className="mb-3">
                                <label>Name</label>
                                <Field type="text" className="form-control" placeholder="Enter Name" name="userName" autoComplete="off"/>
                                <p className='error'><ErrorMessage name="userName" /></p>
                            </div>

                            <div className="mb-3">
                                <label className='foremail'>Email</label>
                                <Field type="text" className="form-control" placeholder="Enter Email" name="email" autoComplete="off"/>
                            ...
                            <div className="mb-3">
                                ...
                                <Field type="password" className="form-control" placeholder="Enter Confirm Password" name="confirmPassword"/>
                                <p className='error'><ErrorMessage name="confirmPassword" /></p>
                            </div>

                            <div>
                                <Field type="checkbox" className="form-check-input" id="exampleCheck1" name="remember" />
                            </div>
